...
- **Metric Depth Note** : 
  - **Model** `DA3METRIC-LARGEMonocular` use `metric_depth = focal * net_output / 300`, where focal is the focal length in pixels (typically the average of fx and fy from the camera intrinsic matrix K).
  - **Model** `DA3NESTED-GIANT-LARGE` is already in meters. 
