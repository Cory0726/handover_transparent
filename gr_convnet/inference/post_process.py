...
def post_process_output(q_img, cos_img, sin_img, width_img, output_size):
    """
    ...
    width_img = cv2.resize(width_img, (output_size, output_size), interpolation=cv2.INTER_LINEAR)
